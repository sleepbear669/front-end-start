/**
 * Created by sleepbear on 2015-04-29.
 */
$(document).ready(function(){
    var todayPhoto = {
        ...
        ,totalPageNum : function(){return parseInt(this.img.length/3)+1}
        ,nextPage : function(){
            this.currentNum = (++this.currentNum)%this.totalPageNum();
        }
